...
import { updateService } from "@/app/actions/actions";
...
const EditServiceForm: React.FC<EditServiceFormProps> = ({
  ...
  const [selectedStaff, setSelectedStaff] = useState<string[]>(service.staffs);
  const serviceCategoryAndTax = serviceTaxCodes;
  const [selectedCategory, setSelectedCategory] = useState<string>(
    service.category.taxCode
  );
  ...
  useEffect(() => {
    const service = serviceCategoryAndTax.find(
  ...
  const updateServiceWithStaff = updateService.bind(null, selectedStaff);
  const [state, formAction] = useFormState(
    updateServiceWithStaff,
    initialValue
  );
  ...
  return (
    <Stack spacing={4}>
      <form action={formAction}>
                ...
                <Stack spacing={2}>
                  ...
                  <FormControl fullWidth required>
                    ...
                    <Select
                      ...
                      value={service.category.taxCode}
        ...
        <input hidden defaultValue={service._id} name="id" />
              ...
              <Grid2 size={{ xs: 12, md: 8 }}>
                <Stack direction="column" spacing={2}>
                  ...
                  <Stack direction="row" spacing={2}>
                    <TextField
                      defaultValue={service.estimatedTime?.hours}
                      label="Hours"
                      variant="outlined"
                      fullWidth
                      name="estimatedHours"
                    ...
                    />
                    <TextField
                      defaultValue={service.estimatedTime?.minutes}
                      label="Minutes"
                      variant="outlined"
                      fullWidth
                  ...
                  <Stack direction="row" spacing={2}>
                    <TextField
                      defaultValue={service.bufferTime?.hours}
                      label="Hours"
                      variant="outlined"
                      fullWidth
                      name="bufferHours"
                    ...
                    />
                    <TextField
                      defaultValue={service.bufferTime?.minutes}
                      label="Minutes"
                      variant="outlined"
                      fullWidth
                      name="bufferMinutes"
      ...
      <AddonManager addons={addons} serviceId={service._id} />
    </Stack>
  );
};
